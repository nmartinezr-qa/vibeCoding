...
import { Toast as ToastType } from "@/src/types/toast.types";
...
export default function Toast({ toast }: ToastProps) {
  ...
  return (
    <div
      className={`
      ${style.container}
      border-l-4 p-6 mb-4 rounded-r-lg shadow-lg
    ...
    >
      <div className="flex items-start">
        <div className={`flex-shrink-0 ${style.icon} mr-4`}>
      ...
      {!toast.persistent && (
        <div className="mt-4">
          <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
            <div
              className={`
                ${style.progress} h-2 rounded-full transition-all ease-linear
              `}
              style={{
